		...
		args = {
			general = {
				...
				args = {
					...
					headerLook = { type = "header", order = 4, name = "Darstellung" },
					barTexture = {
						type = "select", order = 5, name = "Leisten-Textur",
						desc = "Textur für alle Leisten (Knochenschild, Runen, Runenmacht).",
						values = function() return BDK:GetTextureValues() end,
						get = function() return BDK.db.profile.general.barTexture end,
						set = function(_, v) BDK.db.profile.general.barTexture = v BDK:ApplySettings() end,
					},
					backgroundAlpha = {
						type = "range", order = 6, name = "Hintergrund-Transparenz",
						min = 0, max = 1, step = 0.05, isPercent = true,
						get = function() return BDK.db.profile.general.backgroundAlpha end,
						set = function(_, v) BDK.db.profile.general.backgroundAlpha = v BDK:ApplySettings() end,
					},
					headerSound = { type = "header", order = 7, name = "Sound" },
					soundChannel = {
						type = "select", order = 8, name = "Sound-Kanal",
						desc = "Über welchen Lautstärke-Regler die Warnungen laufen. 'Master' ist auch bei stummgeschalteten Effekten hörbar.",
						values = function() return BDK.SoundChannels end,
						get = function() return BDK.db.profile.general.soundChannel end,
						set = function(_, v) BDK.db.profile.general.soundChannel = v end,
					},
					slash = {
			...
			boneShield = {
				...
				args = {
					...
					fontSize = getRange("Schriftgröße (Stack-Zahl)", 10, 32, 1, 9.1),
					showStackText = { type = "toggle", order = 9.2, name = "Stack-Zahl anzeigen" },
					showTimeText = { type = "toggle", order = 9.3, name = "Restlaufzeit anzeigen" },
					showDurationBar = { type = "toggle", order = 9.4, name = "Zeitleiste anzeigen", desc = "Dünne Leiste unter der Stack-Leiste, die die Restlaufzeit als Balken zeigt." },
			...
			resources = {
				...
				args = {
					...
					showPowerText = { type = "toggle", order = 3.1, name = "Runenmacht-Text", desc = "Zahlenwert auf der Runenmacht-Leiste." },
					runeCooldownNumbers = { type = "toggle", order = 3.2, name = "Runen-Countdown", desc = "Sekundenzahl auf nachladenden Runen." },
					alwaysShow = { type = "toggle", order = 3.3, name = "Immer anzeigen", desc = "Sonst nur im Kampf oder mit vorhandener Runenmacht." },
			...
			deathStrike = {
				...
				args = {
					...
					showIcon = { type = "toggle", order = 3, name = "Todesstoß-Icon anzeigen" },
					fontSize = getRange("Schriftgröße", 10, 28, 1, 4),
					textColor = { type = "color", order = 4.1, name = "Textfarbe", get = getColor, set = setColor },
			...
			cooldowns = {
				...
				args = {
					...
					iconsPerRow = getRange("Icons pro Reihe", 1, 12, 1, 5.1),
					growDirection = {
						type = "select", order = 5.2, name = "Wuchsrichtung",
						values = { RIGHT = "Nach rechts", LEFT = "Nach links" },
					},
					...
					alwaysShow = { type = "toggle", order = 8, name = "Immer anzeigen", desc = "Sonst nur im Kampf." },
